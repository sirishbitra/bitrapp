...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'bitrApp';
...
angular.module('contacts').factory('Contacts', ['$resource',
	function($resource) {
		return $resource('contacts/:contactId', { contactId: '@_id', userId: ''
		}, {
			update: {
				method: 'PUT'
			},
...
angular.module('core').controller('HomeController', ['$scope', 'Authentication', 'Watools', '$location', '$rootScope', 'Contacts',
	function($scope, Authentication, Watools, $location, $rootScope, Contacts) {
		...
		$scope.chatRoom = function(){
			...
			//var contact = new Contacts({userId:$scope.authentication.user._id});
			Contacts.$getByUser({userId:$scope.authentication.user._id}).$promise.then(function(res){
				$scope.contacts = res;
...
angular.module('core').service('Menus', [
	...
	.service('Watools', ['$http', 'Authentication',
...
angular.module('groups').config(['$stateProvider',
	function($stateProvider) {
		...
		state('listGroups', {
			url: '/groups',
			templateUrl: 'modules/groups/views/list-group.client.view.html'
		}).
		state('createGroup', {
			url: '/groups/create',
...
// Contacts controller
angular.module('groups').controller('groupsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Groups', 'Contacts',
	function($scope, $stateParams, $location, Authentication, Contacts) {
		$scope.authentication = Authentication;
